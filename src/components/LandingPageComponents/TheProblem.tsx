...
const TheProblem = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-12 md:mt-20 px-4 mb-20">
      {/* Header Badge */}
      <div className="bg-dark-gray px-3 py-1 rounded-lg border border-divider flex gap-1 items-center">
      ...
      {/* Title */}
      <div className="text-white tracking-tighter text-2xl sm:text-4xl lg:text-[65px] lg:leading-[1.2] font-semibold flex flex-col items-center mt-5 text-center mb-5">
      ...
      <div className="relative w-full max-w-5xl flex justify-center">
        ...
        ></div>
        {/* "The Pain" badge */}
        <div className="absolute top-5 sm:top-10 left-1/2 -translate-x-1/2 z-30 flex items-center gap-2 text-sm text-white py-1 px-3 rounded-full border border-divider bg-background/50 backdrop-blur-sm whitespace-nowrap">
          <GoDotFill className="text-primary" />
          The Pain
        </div>
        ...
        <div
          className="relative z-0 h-[650px] w-full rounded-[48px] border border-divider overflow-hidden"
          style={{
            background: "#080808",
          }}
        >
          ...
          {/* Grain/noise texture if desired (optional, skipped for now for simplicity) */}
        </div>
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="relative w-[85%] sm:w-[75%] md:w-[65%] grid sm:grid-cols-2 grid-rows-2 gap-4 sm:gap-6 md:gap-10">
            ...
            <motion.div
              ...
              className="absolute hidden sm:block top-1/2 left-0 w-full h-px bg-linear-to-r from-transparent via-divider to-transparent -translate-y-1/2 pointer-events-none"
            />
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              transition={{ duration: 1 }}
              className="hidden sm:block absolute left-1/2 top-0 h-full w-px bg-linear-to-b from-transparent via-divider to-transparent -translate-x-1/2 pointer-events-none"
            />
            ...
            {problems.map((p, idx) => (
              ...
              >
                <div className="bg-primary/10 backdrop-blur-md rounded-md border-t-primary border-t-[3px] p-2 sm:p-4 mb-2 flex items-center justify-center">
                  {/* <img
                    src={p.img}
                    alt={p.text}
